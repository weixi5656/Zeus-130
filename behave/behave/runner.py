...
class Runner(ModelRunner):
    ...
    def setup_paths(self,project=None):
    ...
    def run(self,project):
        with self.path_manager:
            self.setup_paths(project)
            return self.run_with_paths(project)    # by guohongjie 传入功能域

    def run_with_paths(self,project=None):
        self.context = Context(self)
        self.load_hooks()
        ...
        feature_locations = project   #by guohongjie 功能域覆盖feature_locations
