...
from behave.sql import betaDB,getFeature,getScenario,getStep

DEFAULT_LANGUAGE = "en"
def parse_feature_scenario_step(feature, language=None):
    featureStr = "Feature: {feature}\r\n".format(feature=feature.encode("utf8"))
    # dataFeature = getFeature(feature)
    dataScenario = getScenario(feature)
    dataStep = getStep(dataScenario)
    data = featureStr+dataStep
    # return data.decode("utf8")
    return parse_feature(data.decode("utf8"), language, feature)
